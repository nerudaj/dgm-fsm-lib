    ...
    namespace fsm
    {
        namespace detail
        {
            ...
            public:
                ...
                static [[nodiscard]] std::vector<
                    CompiledConditionalTransition<BbT>>
                    ...
                    const StateIndex& index)
                {
                    return transitions
                           | std::views::transform(
                               [&](ConditionalTransitionContext<BbT>&
                                       transition)
                               {
                ...
                template<BlackboardTypeConcept BbT>
                static [[nodiscard]] CompiledState<BbT> compileState(
                    ...
                    BuilderContext<BbT>& context, const StateIndex& index)
                {
                    return index.getIndexedStateNames()
                           ...
                           | std::views::transform(
                               [&context,
                                &index](const std::pair<MachineId, StateId>&
                                            namePair)
                               {
                                   return compileState(
