    ...
    var t = {
        ...
        187: t=>{
            ...
            function l(t, e, r, i) {
                ...
                void 0 === a)
                    a = o[e] = r,
                    ++t._eventsCount;
                else if ("function" == typeof a ? a = o[e] = i ? [r, a] : [a, r] : i ? a.unshift(r) : a.push(r),
            ...
            var a = r(751)
              ...
              , u = function(t) {
                ...
                e.prototype.getBoundedRatio = function(t) {
                    var e = t;
                    return "number" == typeof this.minRatio && (e = Math.max(e, this.minRatio)),
                    "number" == typeof this.maxRatio && (e = Math.min(e, this.maxRatio)),
                    e
                }
                ,
                e.prototype.validateState = function(t) {
                    var e = {};
                    return "number" == typeof t.x && (e.x = t.x),
                    "number" == typeof t.y && (e.y = t.y),
                    "number" == typeof t.angle && (e.angle = t.angle),
                    "number" == typeof t.ratio && (e.ratio = this.getBoundedRatio(t.ratio)),
                    e
                }
                ,
                ...
                e.prototype.setState = function(t) {
                    ...
                    return "number" == typeof e.x && (this.x = e.x),
                ...
                e.prototype.updateState = function(t) {
                    return this.setState(t(this.getState())),
                    this
                }
                ,
                    ...
                    if (this.enabled) {
                        var n = Object.assign({}, a.ANIMATE_DEFAULTS, e)
                          ...
                          , d = function() {
                            ...
                            if (t >= 1)
                                return i.nextFrame = null,
                                i.setState(o),
                                void (i.animationCallback && (i.animationCallback.call(null),
              ...
              , l = function(t) {
                ...
                e.prototype.handleClick = function(t) {
                    ...
                    if (this.enabled) {
                        ...
                        2 === this.clicks)
                            ...
                            "number" == typeof this.doubleClickTimeout && (clearTimeout(this.doubleClickTimeout),
                        ...
                        this.draggedEvents < 3 && this.emit("click", (0,
                        h.getMouseCoords)(t, this.container))
                    }
                }
                ,
                e.prototype.handleRightClick = function(t) {
                    this.enabled && this.emit("rightClick", (0,
                    h.getMouseCoords)(t, this.container))
                }
                ,
                e.prototype.handleDoubleClick = function(t) {
                    if (this.enabled) {
                        ...
                        var e = (0,
                        h.getMouseCoords)(t, this.container);
                        if (this.emit("doubleClick", e),
                        !e.sigmaDefaultPrevented) {
                            var r = this.renderer.getCamera()
                              , i = r.getBoundedRatio(r.getState().ratio / 2.2);
                            r.animate(this.renderer.getViewportZoomedState((0,
                            h.getPosition)(t, this.container), i), {
                ...
                e.prototype.handleDown = function(t) {
                    if (this.enabled) {
                        if (0 === t.button) {
                            ...
                            var e = (0,
                            h.getPosition)(t, this.container)
                              , r = e.x
                              , i = e.y;
                            this.lastMouseX = r,
                            this.lastMouseY = i,
                ...
                e.prototype.handleWheel = function(t) {
                    ...
                    if (this.enabled) {
                        ...
                        if (r) {
                            var i = (0,
                            h.getWheelCoords)(t, this.container);
                            if (this.emit("wheel", i),
                            !i.sigmaDefaultPrevented) {
                                var n = r > 0 ? 1 / 1.7 : 1.7
                                  , o = this.renderer.getCamera()
                                  , a = o.getBoundedRatio(o.getState().ratio * n)
                                  , s = r > 0 ? 1 : -1
                                  , l = Date.now();
                                this.currentWheelDirection === s && this.lastWheelTriggerTime && l - this.lastWheelTriggerTime < 50 || (o.animate(this.renderer.getViewportZoomedState((0,
                                h.getPosition)(t, this.container), a), {
                                    easing: "quadraticOut",
                                    duration: 250
                                }, (function() {
            ...
            var l = s(r(291))
              , c = function(t) {
                ...
                e.prototype.handleStart = function(t) {
                    ...
                    if (this.enabled) {
                        t.preventDefault(),
                        1 === t.touches.length && this.dispatchRelatedMouseEvent("mousedown", t);
                        var r = (0,
                        l.getTouchesArray)(t.touches);
                        if (this.touchMode = r.length,
                        this.startCameraState = this.renderer.getCamera().getState(),
                        this.startTouchesPositions = r.map((function(t) {
                            return (0,
                            l.getPosition)(t, e.container)
                        }
                        )),
                        this.lastTouches = r,
                        ...
                        2 === this.touchMode) {
                            ...
                            this.startTouchesDistance = Math.sqrt(Math.pow(c - o, 2) + Math.pow(u - a, 2))
                        }
                        this.emit("touchdown", (0,
                        l.getTouchCoords)(t, this.container))
                    }
                }
                ,
                e.prototype.handleLeave = function(t) {
                    if (this.enabled) {
                        ...
                        0 === t.touches.length && this.lastTouches && this.lastTouches.length && (this.dispatchRelatedMouseEvent("mouseup", t, this.lastTouches[0], document),
                        this.hasMoved || this.dispatchRelatedMouseEvent("click", t, this.lastTouches[0])),
                        this.movingTimeout && (this.isMoving = !1,
                ...
                e.prototype.handleMove = function(t) {
                    ...
                    if (this.enabled) {
                        t.preventDefault(),
                        1 === t.touches.length && this.dispatchRelatedMouseEvent("mousemove", t);
                        var i = (0,
                        l.getTouchesArray)(t.touches)
                          , n = i.map((function(t) {
                            return (0,
                            l.getPosition)(t, r.container)
                        }
                        ));
                        if (this.lastTouches = i,
                        this.lastTouchesPositions = n,
                        this.hasMoved || (this.hasMoved = n.some((function(t, e) {
              ...
              , i = function() {
                ...
                t.prototype.getLabelsToDisplay = function(t, e) {
                    ...
                    for (var a in this.cells)
                        for (var s = this.cells[a], h = 0; h < Math.min(n, s.length); h++)
                            o.push(s[h].key);
                    return o
                }
                ,
        ...
        134: function(t, e, r) {
            ...
            var u = function() {
                function t(t) {
                    var e;
                    void 0 === t && (t = {}),
                    this.containers = ((e = {})[5460] = [],
                    e),
                    this.cache = null,
                    this.lastRectangle = null;
                    var r = Math.pow(4, 5);
                    this.data = new Float32Array((4 * r - 1) / 3 * 4),
                    t.boundaries ? this.resize(t.boundaries) : this.resize({
                        x: 0,
                        y: 0,
                        width: 1,
                        height: 1
                ...
                return t.prototype.add = function(t, e, r, i) {
                    return function(t, e, r, i, n, a, s) {
                        for (var l = n - s, c = a - s, u = 2 * s, d = 0, f = 0; ; ) {
                            ...
                            if (0 === w && 0 === d)
                                return r[5460].push(i),
                                void (!o && r[5460].length >= 5 && (o = !0,
                            ...
                            if (0 === w)
                                throw new Error("sigma/quadtree.insertNode: no collision (level: ".concat(d, ", key: ").concat(i, ", x: ").concat(n, ", y: ").concat(a, ", size: ").concat(s, ")."));
                            if (3 === w)
                                throw new Error("sigma/quadtree.insertNode: 3 impossible collisions (level: ".concat(d, ", key: ").concat(i, ", x: ").concat(n, ", y: ").concat(a, ", size: ").concat(s, ")."));
                            if (w > 1)
                                return r[f] = r[f] || [],
                                void r[f].push(i);
                            d++,
                ...
                t.prototype.point = function(t, e) {
                    ...
                    do {
                        this.containers[i] && (0,
                        n.default)(r, this.containers[i]),
                        i = 4 * i + 4 * c(t, e, this.data[i + 0], this.data[i + 1], this.data[i + 2], this.data[i + 3]),
                        o++
                    } while (o <= 5);
                    return r
                }
                ...
                t.prototype.rectangle = function(t, e, r, i, o) {
                    ...
                    (0,
                    n.default)(this.cache, this.containers[5460])),
                    this.cache
                }
                ,
                t
        ...
        942: (t,e)=>{
            ...
            e.default = function(t, e, r, i, n) {
                ...
                if (l) {
                    ...
                    var c, u, d = r.size, f = i.size, p = r.x, g = r.y, v = i.x, m = i.y, y = v - p, b = m - g, _ = Math.sqrt(y * y + b * b);
                    if (!(_ < d + f)) {
                        c = ((p += y * d / _) + (v -= y * f / _)) / 2,
                        u = ((g += b * d / _) + (m -= b * f / _)) / 2,
                        y = v - p,
                        b = m - g,
                        _ = Math.sqrt(y * y + b * b);
                        var x, w = t.measureText(l).width;
                        if (w > _) {
                            for (l += "…",
                            w = t.measureText(l).width; w > _ && l.length > 1; )
                                l = l.slice(0, -2) + "…",
        ...
        61: function(t, e, r) {
            ...
            e.default = function(t, e, r) {
                var i = r.labelSize
                  , o = r.labelFont
                  , a = r.labelWeight;
                if (t.font = "".concat(a, " ").concat(i, "px ").concat(o),
                t.fillStyle = "#FFF",
                t.shadowOffsetX = 0,
                t.shadowOffsetY = 0,
                t.shadowBlur = 8,
            ...
            var i = r(706)
              , n = function() {
                function t(t, e, r, n, o) {
                    ...
                    this.vertexShader = (0,
                    i.loadVertexShader)(t, this.vertexShaderSource),
                    this.fragmentShader = (0,
                    i.loadFragmentShader)(t, this.fragmentShaderSource),
                    this.program = (0,
                    i.loadProgram)(t, [this.vertexShader, this.fragmentShader])
                }
        ...
        569: function(t, e, r) {
            ...
            var n = r(195)
              ...
              , a = i(r(483))
              , s = (0,
            n.createEdgeCompoundProgram)([a.default, o.default]);
            e.default = s
        },
        805: function(t, e, r) {
            "use strict";
            ...
            var a = r(928)
              ...
              , l = function(t) {
                function e(e) {
                    ...
                    return r.correctionRatioLocation = o,
                    r.bind(),
                    r
                }
                return n(e, t),
                ...
                e.prototype.process = function(t, e, r, i, n) {
                    if (i)
                        ...
                        var h = r.size || 1
                          ...
                          , f = e.y
                          , p = (0,
                        a.floatColor)(r.color)
                          , g = d - c
                          , v = f - u
                          , m = g * g + v * v
                          , y = 0
                          , b = 0;
                        m && (y = -v * (m = 1 / Math.sqrt(m)) * h,
                        b = g * m * h);
                        var _ = 27 * n
                          , x = this.array;
                        x[_++] = d,
            ...
            var a = r(195)
              ...
              , c = function(t) {
                function e(e) {
                    ...
                    return r.correctionRatioLocation = a,
                    r.canUse32BitsIndices = (0,
                    s.canUse32BitsIndices)(e),
            ...
            var a = r(928)
              ...
              , l = function(t) {
                function e(e) {
                    ...
                    return r.sqrtZoomRatioLocation = l,
                    r.canUse32BitsIndices = (0,
                    a.canUse32BitsIndices)(e),
                    r.IndicesArray = r.canUse32BitsIndices ? Uint32Array : Uint16Array,
                    r.indicesArray = new r.IndicesArray,
                    r.indicesType = r.canUse32BitsIndices ? e.UNSIGNED_INT : e.UNSIGNED_SHORT,
                    r.bind(),
        ...
        310: function(t, e, r) {
            ...
            e.resolveSettings = function(t) {
                var r = (0,
                n.assign)({}, e.DEFAULT_SETTINGS, t);
                return r.nodeProgramClasses = (0,
                n.assign)({}, e.DEFAULT_NODE_PROGRAM_CLASSES, r.nodeProgramClasses),
                r.edgeProgramClasses = (0,
                n.assign)({}, e.DEFAULT_EDGE_PROGRAM_CLASSES, r.edgeProgramClasses),
                r
            }
        },
        159: function(t, e, r) {
            ...
            function b(t, e, r) {
                if (!r.hasOwnProperty("x") || !r.hasOwnProperty("y"))
                    throw new Error('Sigma: could not find a valid position (x, y) for node "'.concat(e, '". All your nodes must have a number "x" and "y". Maybe your forgot to apply a layout or your "nodeReducer" is not returning the correct data?'));
                return r.color || (r.color = t.defaultNodeColor),
            ...
            function _(t, e, r) {
                return r.color || (r.color = t.defaultEdgeColor),
                r.label || (r.label = ""),
                r.size || (r.size = .5),
                r.hasOwnProperty("hidden") || (r.hidden = !1),
                r.hasOwnProperty("forceLabel") || (r.forceLabel = !1),
            ...
            var x = function(t) {
                function e(e, r, i) {
                    ...
                    n.correctionRatio = 1,
                    n.customBBox = null,
                    n.normalizationFunction = (0,
                    f.createNormalizationFunction)({
                        x: [0, 1],
                        y: [0, 1]
                    }),
                    n.cameraSizeRatio = 1,
                    ...
                    for (var s in n.settings.nodeProgramClasses) {
                        ...
                        var d = h;
                        s in n.settings.nodeHoverProgramClasses && (d = n.settings.nodeHoverProgramClasses[s]),
                ...
                e.prototype.createWebGLContext = function(t, e) {
                    var r, i = this.createCanvas(t), n = o({
                        preserveDrawingBuffer: !1,
                        antialias: !1
                    }, e || {});
                    return (r = i.getContext("webgl2", n)) || (r = i.getContext("webgl", n)),
                ...
                e.prototype.bindEventHandlers = function() {
                    ...
                    this.activeListeners.handleMove = function(e) {
                        ...
                        if (i && t.hoveredNode !== i && !t.nodeDataCache[i].hidden)
                            return t.hoveredNode && t.emit("leaveNode", o(o({}, r), {
                                node: t.hoveredNode
                            })),
                            t.hoveredNode = i,
                            t.emit("enterNode", o(o({}, r), {
                                node: i
                            })),
                        ...
                        if (t.hoveredNode) {
                            ...
                            if (!t.mouseIsOnNode(e, a, s)) {
                                var h = t.hoveredNode;
                                return t.hoveredNode = null,
                                t.emit("leaveNode", o(o({}, r), {
                                    node: h
                                })),
                                void t.scheduleHighlightedNodesRender()
                            }
                        }
                        !0 === t.settings.enableEdgeHoverEvents ? t.checkEdgeHoverEvents(r) : "debounce" === t.settings.enableEdgeHoverEvents && (t.checkEdgesEventsFrame || (t.checkEdgesEventsFrame = (0,
                        f.requestFrame)((function() {
                    ...
                    return this.activeListeners.handleClick = e("click"),
                ...
                e.prototype.getEdgeAtPoint = function(t, e) {
                    var r, i, n = this, o = this.edgeDataCache, s = this.nodeDataCache;
                    if (!(0,
                    y.isPixelColored)(this.webGLContexts.edges, t * this.pixelRatio, e * this.pixelRatio))
                        return null;
                    ...
                    if (this.graph.someEdge((function(t, e, r, i, a, h) {
                        var l = a.x
                          ...
                          , d = h.x
                          , f = h.y;
                        if (o[t].hidden || s[r].hidden || s[i].hidden)
                            return !1;
                        if (l !== d || c !== f) {
                    ...
                    var d = this.graph.filterEdges((function(t, e, r, i, a, h) {
                        return !(o[t].hidden || s[r].hidden || s[i].hidden) && (!!(0,
                        y.doEdgeCollideWithPoint)(l, c, a.x, a.y, h.x, h.y, o[t].size * u / n.cameraSizeRatio) || void 0)
                    }
                    ));
                    if (0 === d.length)
                        return null;
                ...
                e.prototype.process = function(t) {
                    ...
                    var s = new l.default
                      , h = (0,
                    f.matrixFromCamera)(s.getState(), this.getDimensions(), this.getGraphDimensions(), this.getSetting("stagePadding") || 0);
                    this.normalizationFunction = (0,
                    f.createNormalizationFunction)(this.customBBox || this.nodeExtent);
                    for (var c = {}, u = r.nodes(), d = 0, p = u.length; d < p; d++) {
                        ...
                        this.settings.zIndex && (y.zIndex < o[0] && (o[0] = y.zIndex),
                        y.zIndex > o[1] && (o[1] = y.zIndex))
                    }
                    for (var m in this.nodePrograms) {
                        if (!this.nodePrograms.hasOwnProperty(m))
                            throw new Error('Sigma: could not find a suitable program for node type "'.concat(m, '"!'));
                        t || this.nodePrograms[m].allocate(c[m] || 0),
                        c[m] = 0
                    }
                    for (this.settings.zIndex && o[0] !== o[1] && (u = (0,
                    f.zIndexOrdering)(o, (function(t) {
                    ...
                    p = u.length; d < p; d++) {
                        ...
                        "string" != typeof y.label || y.hidden || this.labelGrid.add(g, y.size, this.framedGraphToViewport(y, {
                            matrix: h
                        }));
                        var x = this.nodePrograms[y.type];
                        if (!x)
                            throw new Error('Sigma: could not find a suitable program for node type "'.concat(y.type, '"!'));
                    ...
                    p = E.length; d < p; d++) {
                        ...
                        this.settings.zIndex && (y.zIndex < a[0] && (a[0] = y.zIndex),
                        y.zIndex > a[1] && (a[1] = y.zIndex))
                    }
                    for (var m in this.edgePrograms) {
                        if (!this.edgePrograms.hasOwnProperty(m))
                            throw new Error('Sigma: could not find a suitable program for edge type "'.concat(m, '"!'));
                        t || this.edgePrograms[m].allocate(w[m] || 0),
                        w[m] = 0
                    }
                    for (this.settings.zIndex && a[0] !== a[1] && (E = (0,
                    f.zIndexOrdering)(a, (function(t) {
                ...
                e.prototype.handleSettingsUpdate = function() {
                    return this.camera.minRatio = this.settings.minCameraRatio,
                ...
                e.prototype._refresh = function() {
                    return this.needToProcess ? this.process() : this.needToSoftProcess && this.process(!0),
                ...
                e.prototype._scheduleRefresh = function() {
                    var t = this;
                    return this.renderFrame || (this.renderFrame = (0,
                    f.requestFrame)((function() {
                        t._refresh(),
                        t.renderFrame = null
                    }
                ...
                e.prototype.renderLabels = function() {
                    ...
                    (0,
                    h.default)(e, this.nodesWithForcedLabels),
                    ...
                    for (var r = this.canvasContexts.labels, i = 0, n = e.length; i < n; i++) {
                        ...
                        if (!this.displayedLabels.has(a) && !s.hidden) {
                            ...
                            !s.forceLabel && d < this.settings.labelRenderedSizeThreshold || c < -150 || c > this.width + 150 || u < -50 || u > this.height + 50 || (this.displayedLabels.add(a),
                            this.settings.labelRenderer(r, o(o({
                                key: a
                            }, s), {
                                size: d,
                                x: c,
                ...
                e.prototype.renderEdgeLabels = function() {
                    ...
                    for (var e = (0,
                    p.edgeLabelsToDisplayFromNodes)({
                        graph: this.graph,
                ...
                e.prototype.renderHighlightedNodes = function() {
                    ...
                    this.nodeHoverPrograms)
                        this.nodeHoverPrograms[n].allocate(i[n] || 0),
                        i[n] = 0;
                    for (var n in r.forEach((function(e) {
                ...
                e.prototype.scheduleHighlightedNodesRender = function() {
                    var t = this;
                    this.renderHighlightedNodesFrame || this.renderFrame || (this.renderHighlightedNodesFrame = (0,
                    f.requestFrame)((function() {
                ...
                e.prototype.render = function() {
                    ...
                    var e = function() {
                        return t.emit("afterRender"),
                        t
                    };
                    if (this.renderFrame && ((0,
                    f.cancelFrame)(this.renderFrame),
                    ...
                    for (var h in this.matrix = (0,
                    f.matrixFromCamera)(n, o, a, s),
                    this.invMatrix = (0,
                    f.matrixFromCamera)(n, o, a, s, !0),
                    this.correctionRatio = (0,
                    f.getMatrixImpact)(this.matrix, n, o),
                    this.nodePrograms)
                    ...
                    return this.settings.hideLabelsOnMove && i || (this.renderLabels(),
                ...
                e.prototype.setGraph = function(t) {
                    t !== this.graph && (this.unbindGraphHandlers(),
                    this.nodeDataCache = {},
                    this.edgeDataCache = {},
                    ...
                    null !== this.checkEdgesEventsFrame && ((0,
                    f.cancelFrame)(this.checkEdgesEventsFrame),
                ...
                e.prototype.setSetting = function(t, e) {
                    ...
                    (0,
                    g.validateSettings)(this.settings),
                ...
                e.prototype.updateSetting = function(t, e) {
                    return this.settings[t] = e(this.settings[t]),
                    (0,
                    g.validateSettings)(this.settings),
                    this.handleSettingsUpdate(),
                    this.needToProcess = !0,
                ...
                e.prototype.clear = function() {
                    return this.webGLContexts.nodes.clear(this.webGLContexts.nodes.COLOR_BUFFER_BIT),
                ...
                e.prototype.framedGraphToViewport = function(t, e) {
                    ...
                    var r = !!e.cameraState || !!e.viewportDimensions || !!e.graphDimensions
                      , i = e.matrix ? e.matrix : r ? (0,
                    f.matrixFromCamera)(e.cameraState || this.camera.getState(), e.viewportDimensions || this.getDimensions(), e.graphDimensions || this.getGraphDimensions(), e.padding || this.getSetting("stagePadding") || 0) : this.matrix
                      , n = (0,
                    m.multiplyVec2)(i, t);
                    return {
                ...
                e.prototype.viewportToFramedGraph = function(t, e) {
                    ...
                    var r = !!e.cameraState || !!e.viewportDimensions || !e.graphDimensions
                      , i = e.matrix ? e.matrix : r ? (0,
                    f.matrixFromCamera)(e.cameraState || this.camera.getState(), e.viewportDimensions || this.getDimensions(), e.graphDimensions || this.getGraphDimensions(), e.padding || this.getSetting("stagePadding") || 0, !0) : this.invMatrix
                      , n = (0,
                    m.multiplyVec2)(i, {
                        x: t.x / this.width * 2 - 1,
                        y: 1 - t.y / this.height * 2
                    });
                    return isNaN(n.x) && (n.x = 0),
                    isNaN(n.y) && (n.y = 0),
                    n
                }
                ,
                e.prototype.viewportToGraph = function(t, e) {
                    return void 0 === e && (e = {}),
                    this.normalizationFunction.inverse(this.viewportToFramedGraph(t, e))
                }
                ,
                ...
                e.prototype.kill = function() {
                    ...
                    f.cancelFrame)(this.renderFrame),
                    this.renderFrame = null),
                    this.renderHighlightedNodesFrame && ((0,
                    f.cancelFrame)(this.renderHighlightedNodesFrame),
        ...
        628: (t,e)=>{
            ...
            e.isPixelColored = function(t, e, r) {
                ...
                return t.readPixels(e, t.drawingBufferHeight - r, 1, 1, t.RGBA, t.UNSIGNED_BYTE, i),
                i[3] > 0
            }
            ,
        ...
        928: function(t, e, r) {
            ...
            function p(t) {
                var e = 0
                  ...
                  , n = 1;
                if ("#" === t[0])
                    4 === t.length ? (e = parseInt(t.charAt(1) + t.charAt(1), 16),
                    r = parseInt(t.charAt(2) + t.charAt(2), 16),
                    i = parseInt(t.charAt(3) + t.charAt(3), 16)) : (e = parseInt(t.charAt(1) + t.charAt(2), 16),
            ...
            for (var v in s.HTML_COLORS)
                g[v] = m(s.HTML_COLORS[v]),
                g[s.HTML_COLORS[v]] = g[v];
            function m(t) {
                if (void 0 !== g[t])
                    return g[t];
                var e = p(t)
            ...
            e.matrixFromCamera = function(t, e, r, i, n) {
                ...
                a.multiply)(d, (0,
                a.scale)((0,
                a.identity)(), c / f / 2 / p, u / f / 2 / p))) : ((0,
                a.multiply)(d, (0,
                a.scale)((0,
                a.identity)(), f / c * 2 * p, f / u * 2 * p)),
                (0,
                a.multiply)(d, (0,
                a.rotate)((0,
                a.identity)(), -o)),
            ...
            e.extractPixel = function(t, e, r, i) {
                ...
                return t.readPixels(e, r, 1, 1, t.RGBA, t.UNSIGNED_BYTE, n),
                n
            }
            ,
            ...
            e.validateGraph = function(t) {
                ...
                t.forEachNode((function(t, e) {
                    if (!Number.isFinite(e.x) || !Number.isFinite(e.y))
                        throw new Error("Sigma: Coordinates of node ".concat(t, " are invalid. A node must have a numeric 'x' and 'y' attribute."))
                }
                ))
            }
        },
